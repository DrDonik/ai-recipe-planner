...
export const translations = {
    English: {
        ...
        welcome: {
            ...
            apiKey: "You'll need an API key to generate recipes. Select your provider and click the link icon to get one.",
    ...
    German: {
        ...
        welcome: {
            ...
            apiKey: "Du benötigst einen API-Schlüssel. Wähle deinen Anbieter und klicke auf das Link-Symbol, um einen zu erhalten.",
    ...
    French: {
        ...
        welcome: {
            ...
            apiKey: "Vous aurez besoin d'une clé API. Sélectionnez votre fournisseur et cliquez sur l'icône de lien pour en obtenir une.",
    ...
    Spanish: {
        ...
        welcome: {
            ...
            apiKey: "Necesitarás una clave API. Selecciona tu proveedor y haz clic en el icono de enlace para obtener una.",
