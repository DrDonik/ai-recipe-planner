...
export const translations = {
    English: {
        ...
        recipeChat: {
            ...
            intro: "Ask anything about this recipe — substitutions, technique, timing. The assistant knows the recipe and the step you're on, but can't change the recipe for you.",
            ...
            suggestions: [
                ...
                "Half the quantity — what changes?",
    ...
    German: {
        ...
        recipeChat: {
            ...
            title: "Küchenhilfe",
            intro: "Frag alles zu diesem Rezept — Ersatzzutaten, Technik, Timing. Die Küchenhilfe kennt das Rezept und den Schritt, bei dem du gerade bist, kann das Rezept aber nicht für dich ändern.",
    ...
    French: {
        ...
        recipeChat: {
            ...
            title: "Aide-cuisine",
            intro: "Pose n'importe quelle question sur cette recette — substitutions, technique, timing. L'aide-cuisine connaît la recette et l'étape où tu en es, mais ne peut pas modifier la recette à ta place.",
            ...
            suggestions: [
                ...
                "Moitié moins — qu'est-ce qui change ?",
    ...
    Spanish: {
        ...
        recipeChat: {
            ...
            intro: "Pregunta lo que quieras sobre esta receta — sustituciones, técnica, tiempos. El ayudante conoce la receta y el paso en el que estás, pero no puede modificar la receta por ti.",
            ...
            suggestions: [
                ...
                "La mitad de cantidad, ¿qué cambia?",
