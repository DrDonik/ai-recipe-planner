...
export const translations = {
    English: {
        ...
        welcome: {
            ...
            apiKey: "Choose from Gemini, OpenAI, or Mistral with an API key, or use 'Copy & Paste' to manually interact with any AI chat—no API key needed.",
    ...
    German: {
        ...
        welcome: {
            ...
            apiKey: "Wähle zwischen Gemini, OpenAI oder Mistral mit einem API-Schlüssel, oder nutze 'Kopieren & Einfügen' für die manuelle Interaktion mit einem beliebigen KI-Chat—kein API-Schlüssel nötig.",
    ...
    French: {
        ...
        apiKeyPlaceholder: "Coller la clé API",
        apiKeyLabel: "Clé API",
        ...
        welcome: {
            ...
            apiKey: "Choisissez Gemini, OpenAI ou Mistral avec une clé API, ou utilisez 'Copier-Coller' pour interagir manuellement avec n'importe quel chat IA—aucune clé API requise.",
    ...
    Spanish: {
        ...
        welcome: {
            ...
            apiKey: "Elige entre Gemini, OpenAI o Mistral con una clave API, o usa 'Copiar y Pegar' para interactuar manualmente con cualquier chat de IA—sin clave API.",
