...
export const buildRecipePrompt = ({
  ...
  return `
    ...
    19. Let the season and any nearby holidays at TODAY's date and time zone gently inform the recipes: which produce is at its best there and then, and whether lighter or heartier dishes fit the time of year. This is a soft guideline only — the dietary preference, style/wishes, requested dishes and good use of my pantry always take precedence, and no recipe should be rejected merely for being out of season. Do not state the date in the output.
