...
export const buildRecipePrompt = ({
  ...
  return `
    ...
    18. Optionally include a "comments" field per recipe (1-2 sentences). Use it for a fun or surprising fact about the dish or its ingredients or a chef's twist -- or, if the user provided unusual or inedible items, a lighthearted remark about why you skipped them.
      ...
      "recipes": [
        {
          ...
          "comments": "(optional) Fun fact, chef's twist or comment about omission of inedible ingredients about this recipe or its ingredients."
        }
      ],
      "shoppingList": [
