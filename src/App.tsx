...
function App() {
  ...
  const { provider, model, apiKey, people, meals, diet, styleWishes, language, t } = useSettings();
  ...
  const handleGenerate = async () => {
    ...
    try {
      const plan = await generateRecipes(provider, model, apiKey, itemsToUse, people, meals, diet, language, spices, styleWishes);
      setMealPlan(plan);
