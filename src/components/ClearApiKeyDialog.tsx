...
export const ClearApiKeyDialog = ({ onClear, onKeep }: ClearApiKeyDialogProps) => {
    const { t } = useSettings();
    // Keeping the key changes nothing, so Escape may land there.
        ...
        >
            ...
            >
                ...
                {/* Coloured by exposure, not by destructiveness: deleting the key
                    ends the exposure the dialog is about, and it keeps its undo,
                    so keeping is the quiet option rather than the safe one. */}
